...
["_fflush","__embind_initialize_bindings","___set_stack_limits","onRuntimeInitialized"].forEach((prop) => {
...
// end include: preamble.js
  ...
  var WebGPU = {errorCallback:function(callback, type, message, userdata) {
        withStackSave(() => {
  ...
  function _wgpuCommandEncoderCopyBufferToBuffer(encoderId, srcId, srcOffset_low, srcOffset_high, dstId, dstOffset_low, dstOffset_high, size_low, size_high) {
      var srcOffset = convertI32PairToI53Checked(srcOffset_low, srcOffset_high); if (isNaN(srcOffset)) return undefined;
      var dstOffset = convertI32PairToI53Checked(dstOffset_low, dstOffset_high); if (isNaN(dstOffset)) return undefined;
      var size = convertI32PairToI53Checked(size_low, size_high); if (isNaN(size)) return undefined;
      var commandEncoder = WebGPU.mgrCommandEncoder.get(encoderId);
  ...
  function _wgpuComputePassEncoderDispatchWorkgroupsIndirect(passId, indirectBufferId, indirectOffset_low, indirectOffset_high) {
      var indirectOffset = convertI32PairToI53Checked(indirectOffset_low, indirectOffset_high); if (isNaN(indirectOffset)) return undefined;
  ...
  function _wgpuComputePassEncoderRelease(id) { WebGPU.mgrComputePassEncoder.release(id) }
  ...
  function _wgpuComputePipelineRelease(id) { WebGPU.mgrComputePipeline.release(id) }
  ...
  function _wgpuDeviceCreateBindGroup(deviceId, descriptor) {
      ...
      function makeEntry(entryPtr) {
        ...
        if (bufferId) {
          ...
          var size = ((size_high === -1 && size_low === -1) ? undefined :           convertI32PairToI53(size_low, size_high));
  ...
  function _wgpuQueueWriteBuffer(queueId,
      ...
      var bufferOffset = convertI32PairToI53Checked(bufferOffset_low, bufferOffset_high); if (isNaN(bufferOffset)) return undefined;
      var queue = WebGPU.mgrQueue.get(queueId);
  ...
  function _wgpuRenderPassEncoderSetIndexBuffer(passId, bufferId, format, offset_low, offset_high, size_low, size_high) {
      var offset = convertI32PairToI53Checked(offset_low, offset_high); if (isNaN(offset)) return undefined;
