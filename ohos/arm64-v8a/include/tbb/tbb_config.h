...
#define __TBB_TSX_INTRINSICS_PRESENT ((__RTM__ || _MSC_VER>=1700 || __INTEL_COMPILER>=1300) && !__TBB_DEFINE_MIC && !__ANDROID__ && !__OHOS__)
...
#define __TBB_RECYCLE_TO_ENQUEUE __TBB_BUILD // keep non-official
    ...
    #define __TBB_ENQUEUE_ENFORCED_CONCURRENCY 1
          ...
          (_WIN32 || _WIN64 || __APPLE__ || (__linux__ && !__ANDROID__  && !__OHOS__))
...
#if __SIZEOF_POINTER__ < 8 && (__ANDROID__ || __OHOS__) && __TBB_GCC_VERSION <= 40403 && !__GCC_HAVE_SYNC_COMPARE_AND_SWAP_8
...
#define __TBB_PREVIEW_RESUMABLE_TASKS           ((__TBB_CPF_BUILD || TBB_PREVIEW_RESUMABLE_TASKS) && !__TBB_WIN8UI_SUPPORT && !__ANDROID__ && !__OHOS__ && !__TBB_ipf)
#endif
